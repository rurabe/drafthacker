class DraftsController < ApplicationController
  ...
  def show
    ...
    if params['access_token']
      ...
      @mega_hash = Cbs::League.build_mega_hash( { :access_token => 'U2FsdGVkX1_dqYNjfcxVhErfEI9MqM7-7hNf7v6d64EzPGAjzKpHFAe8cA3jHI2G_KARduk8IlB7L6WNbPbzlXCz0vpOfb9VebWtJJj2A_mPprAYtwtKY1BeMDB_XcdW', :cbs_id => 'b2c7c77e1b22e0f4' } )
    end
